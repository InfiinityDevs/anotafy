...
export default function Header() {
    return (
        <header className="bg-foreground border-b border-border h-18 px-6 flex items-center justify-between">
            <div className="flex items-center gap-2">
                <Logo className="w-10" />
                <h1 className="font-black text-xl select-none">ANOTAFY</h1>
            </div>
            <div className="flex items-center gap-2 border border-border rounded-lg h-8 p-5 w-100 focus-within:ring-2 focus-within:ring-primary">
